...
function awaitify (asyncFn, arity) {
    ...
    function awaitable (...args) {
        if (typeof args[arity - 1] === 'function') {
            return asyncFn.apply(t @returns {Async   }
 ...
 *
 * // This still has an advantage over plain `auto`, since the re* depends on. Th// depends on are still spread into arguments.
 * async.autoInject({
 *     //...
